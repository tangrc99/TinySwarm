...
class MongoImageOidRange final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR MongoImageOidRange(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const MongoImageOidRange& from) {
    MongoImageOidRange::MergeImpl(*this, from);
  }
  private:
...
class YoloTestResult final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR YoloTestResult(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const YoloTestResult& from) {
    YoloTestResult::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
void MongoImageOidRange::set_min_oid(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.min_oid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void MongoImageOidRange::set_allocated_min_oid(std::string* min_oid) {
  ...
  _impl_.min_oid_.SetAllocated(min_oid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.min_oid_.IsDefault()) {
...
void MongoImageOidRange::set_max_oid(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.max_oid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void MongoImageOidRange::set_allocated_max_oid(std::string* max_oid) {
  ...
  _impl_.max_oid_.SetAllocated(max_oid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.max_oid_.IsDefault()) {
