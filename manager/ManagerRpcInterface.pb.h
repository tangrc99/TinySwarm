...
class ServiceName final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ServiceName(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const ServiceName& from) {
    ServiceName::MergeImpl(*this, from);
  }
  private:
...
class ServiceParams final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ServiceParams(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const ServiceParams& from) {
    ServiceParams::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class AddressPool final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AddressPool(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const AddressPool& from) {
    AddressPool::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline const ::ServiceName& ServiceInfo::_internal_name() const {
  const ::ServiceName* p = _impl_.name_;
...
inline const ::ServiceParams& ServiceInfo::_internal_params() const {
  const ::ServiceParams* p = _impl_.params_;
...
inline ::ServiceParams* ServiceInfo::release_params() {
  ...
  ::ServiceParams* temp = _impl_.params_;
  _impl_.params_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
void AddressPool::set_proxy_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.proxy_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void AddressPool::set_allocated_proxy_address(std::string* proxy_address) {
  ...
  _impl_.proxy_address_.SetAllocated(proxy_address, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.proxy_address_.IsDefault()) {
...
inline int AddressPool::_internal_pod_address_size() const {
  return _impl_.pod_address_.size();
}
...
inline const std::string& AddressPool::_internal_pod_address(int index) const {
  return _impl_.pod_address_.Get(index);
}
...
inline std::string* AddressPool::mutable_pod_address(int index) {
  ...
  return _impl_.pod_address_.Mutable(index);
}
inline void AddressPool::set_pod_address(int index, const std::string& value) {
  _impl_.pod_address_.Mutable(index)->assign(value);
...
inline void AddressPool::set_pod_address(int index, std::string&& value) {
  _impl_.pod_address_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:AddressPool.pod_address)
}
...
inline void AddressPool::add_pod_address(const char* value, size_t size) {
  _impl_.pod_address_.Add()->assign(reinterpret_cast<const char*>(value), size);
